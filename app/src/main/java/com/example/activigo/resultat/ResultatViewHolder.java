...
public class ResultatViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    ResultatViewHolder(View view, ResultatClickListener itemListener) {
        super(view);
